...
class CategorysController extends Controller
{
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['Categorys']))
        {
            ...
            {
	        	if($uploadedFile) {
	                $uploadedFile->saveAs(Yii::app()->basePath.'/../images/category/'.$fileName);  // image will upload to rootDirectory/images/
	        	}
	...
	//if(Yii::app()->user->isGuest) {
		$dataProvider=new CActiveDataProvider('Categorys');
		$categories = Categorys::model()->findAll();
		$this->render('index',array(
			'dataProvider'=>$dataProvider,'categories'=>$categories
		));
	/*}else {
			$this->redirect(array('categorys/admin'));
		}*/
	}
	...
	public function actionAdmin()
	{
		...
		if(isset($_GET['Categorys']))
			$model->attributes=$_GET['Categorys'];
	 ...
	 * @param Categorys $model the model to be validated
	 */
