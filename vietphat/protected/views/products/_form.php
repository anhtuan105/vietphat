...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<!-- <div class="row">
		<?php echo $form->labelEx($model,'discountCost'); ?>
		<?php echo $form->textField($model,'discountCost'); ?>
		<?php echo $form->error($model,'discountCost'); ?>
	</div> -->
	...
	<div class="row">
		...
		<?php echo CHtml::CheckBox('newProduct_check',false); ?>
	</div>

	<div class="row">
		<strong>Sản phẩm nổi bật</strong>
		<?php echo CHtml::CheckBox('hotProduct_check',false); ?>
	</div>
